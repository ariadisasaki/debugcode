...
// === SISTEM AUDIT & DEBUG LOG (V2.8 - FULL DATA RESTORED) ===

// 1. FUNGSI PEMBANTU (Agar Maghrib di Console = UI)
...
function debugHilal() {
    ...
    try {
        ...
        // DASHBOARD 2: ASTRONOMI REAL-TIME (DATA LENGKAP)
        ...
        console.table({
            ...
            "Estimasi Maghrib": formatJamMenit(maghribData.decimal)
        });
        console.groupEnd();
